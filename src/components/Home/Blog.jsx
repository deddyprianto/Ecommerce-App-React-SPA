        ...
        <div className="2xl:mx-auto 2xl:container lg:px-20 lg:py-16 md:py-12 md:px-6 py-9 px-4 w-96 sm:w-auto">
          <div className="flex flex-col items-center justify-center">
            <h1 className="text-4xl font-semibold leading-9 text-center text-gray-800">
              Barang Ready Minggu Ini
            </h1>
            <p className="text-base leading-normal text-center text-gray-600 mt-4 lg:w-1/2 md:w-10/12 w-11/12">
              Malam minggu belanja aja yuk di sini kita menyediakan banyak
              barang dan keperluan rumah tangga anda tanpa keluar rumah anda
              bisa memiliki barang mewah ini
            </p>
          </div>
