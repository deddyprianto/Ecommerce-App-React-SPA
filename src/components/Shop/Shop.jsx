              ...
              <>
                {dataResponse.map((item, i) => (
                  <div
                    ...
                    className="group group-hover:bg-opacity-60 cursor-pointer transition duration-500 relative bg-gray-50 sm:p-28 py-36 px-10 flex justify-center items-center shadow-lg rounded-lg"
                  >
                    <img
                    ...
                    <div className="absolute sm:top-8 top-4 left-4 sm:left-8 flex justify-start items-start flex-col space-y-2">
                      <div>
                        <p className="group-hover:opacity-60 transition duration-500 text-xl leading-5 text-gray-800">
                          {item.title}
                        </p>
                      </div>
                      <div className="flex flex-col">
